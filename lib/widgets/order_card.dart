...
import '../mainScreens/seller_order_detail_screen.dart';
import '../models/items.dart';
import '../user_main/order_detail_screen.dart';
...
class SOrderCard extends StatelessWidget
{
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: ()
      {
        Navigator.push(context, MaterialPageRoute(builder: (c)=> SOrderDetailsScreen(orderID: orderID)));
      },
      child: Container(
